...
if utilidad >= 0
    ...
    puts "La Utilidad obtenida es de $ #{utilidad.round(2)}, con precio venta del producto de $ #{precio_venta}, #{usuarios} usuarios al año, y gastos que ascienden a $ #{gastos}"
